    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                ...
                git url: 'https://github.com/gabrielle-leung/Spring-Boot-Hello-World-Example.git'
            }
        }
                 ...
                 transfers: [
                  sshTransfer(
                   ...
                   execCommand: """
                    ...
                    docker tag springbootapp1 gleung258/springbootapp1:1.0
                    docker push gleung258/springbootapp1:1.0 """
                  )
                 ])
               ])
             }
                 ...
                 transfers: [
                  sshTransfer(
                   ...
                   execCommand: """
                    ...
                    sudo docker run -d -p 8080:8080 gleung258/springbootapp1:1.0; """
                  )
                 ])
               ])
             }
